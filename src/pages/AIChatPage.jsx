...
const AIChatPage = () => {
    ...
    const styles = {
        ...
        input: { flex: 1, padding: '12px 16px', borderRadius: '24px', border: '1px solid #D1D5DB', fontSize: '15px', outline: 'none' },
        ...
        typing: { fontSize: '12px', color: '#9CA3AF', marginBottom: '8px' }
    };
            ...
            <div style={styles.header}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    <div>
                        ...
                        <div style={{ fontSize: '12px', color: '#10B981' }}>Sempre attivo</div>
                    </div>
                </div>
                <button onClick={handleExport} style={{ background: 'none', border: 'none', color: 'var(--color-primary)', fontWeight: 'bold', cursor: 'pointer', fontSize: '13px' }}>
                    Esporta Chat
                </button>
            </div>
